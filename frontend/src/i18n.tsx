...
const STRINGS: Dict = {
  ...
  saveName: { zh: "名称", en: "Name" },
  saveNote: { zh: "备注（可选）", en: "Note (optional)" },
  nav_saved: { zh: "已保存", en: "Saved" },
  saved_title: { zh: "已保存的正则", en: "Saved Regexes" },
  saved_intro: {
    zh: "在任意工具点击「保存」即可存到这里（保存在本浏览器）。可导出/导入以备份。",
    en: "Click Save in any tool to store a regex here (kept in this browser). Export/import to back up.",
  },
  saved_empty: { zh: "还没有保存的正则。", en: "No saved regexes yet." },
